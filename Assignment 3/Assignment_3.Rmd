...
list("Baseline units" = baseline_units,
     ...
     "% incremental units purchase acceleration" = Stockpiling,
     "Incremental units purchase acceleration" = incremental_units_Stockpiling,
     "Incremental units net of purchase acceleration" = incremental_units_net,
...
#For D
#(a) 
ROI_Summary(D_d_f_lm, 0.15)
#(b)
ROI_Summary(D_d_f_lm, 0.15, 0.7)
#(c)
ROI_Summary(D_d_f_lm, 0.15, 0.7, 1)

#Consider stockpiling is 20%
#(a) 
ROI_Summary(D_d_f_lm, 0.15, Stockpiling = 0.2)
#(b)
ROI_Summary(D_d_f_lm, 0.15, 0.7, Stockpiling = 0.2)
#(c)
ROI_Summary(D_d_f_lm, 0.15, 0.7, 1, Stockpiling = 0.2)


#For Jewel
#(a) 
ROI_Summary(J_d_f_lm, 0.15)
#(b)
ROI_Summary(J_d_f_lm, 0.15, 0.7)
#(c)
ROI_Summary(J_d_f_lm, 0.15, 0.7, 1)

#Consider stockpiling is 20%
#(a) 
ROI_Summary(J_d_f_lm, 0.15, Stockpiling = 0.2)
#(b)
ROI_Summary(J_d_f_lm, 0.15, 0.7, Stockpiling = 0.2)
#(c)
ROI_Summary(J_d_f_lm, 0.15, 0.7, 1, Stockpiling = 0.2)
```
